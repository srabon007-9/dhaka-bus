export default function ErrorCard({ title = 'Oops, something went wrong', description, onRetry }) {
  return (
    <div className="rounded-2xl border border-red-400/40 bg-red-900/20 p-6 text-left shadow-lg">
      ...
      <p className="mt-2 text-sm text-red-100/90">{description || 'Please try again in a moment.'}</p>
      {onRetry ? (
